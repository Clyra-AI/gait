...
gait effects grade --snapshot effect_snapshot.json --contract effect_contract.json --trusted-collector-key collector.pub [--allow-fixture-test-provenance] [--junit effects.xml] --json
```
